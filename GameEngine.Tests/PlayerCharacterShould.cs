...
namespace GameEngine.Tests
{
    public class PlayerCharacterShould
    {
        ...
        {
            //it is Arrange part we are setting up unit test making object
        ...
        {
            //it is Arrange part we are setting up unit test making object
            _sut.FirstName = "Yaseen";
            _sut.LastName = "Saleem";

            Assert.Equal("Yaseen Saleem", _sut.FullName);
        }
        ...
        public void HaveFullNameStartingWithFirstName()
        {
            ...
            Assert.StartsWith("Yaseen", _sut.FullName);
        }
